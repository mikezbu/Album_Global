import { Avatar, IconButton, NoSsr, Typography } from '@mui/material'
...
import ArtistModify from 'src/modules/artist/components/ArtistModify'
import ImageCropper from 'src/common/components/image/ImageCropper'
import Modal from 'src/common/components/modal/Modal'
import ArtistForm from 'src/modules/artist/components/ArtistForm'
      ...
      public render() {
        ...
        return (
          <NoSsr>
            ...
            <div className="pl-8 pr-4 pb-12">
              <ArtistModify selectedFiles={this.state.selectedFiles} />
              {/* <ArtistForm
                selectedFiles={this.state.selectedFiles}
                artistId={this.props.userStore.user.artistId}
              /> */}
            </div>
          </NoSsr>
        )
